	...
	<div>
		<div>
			<el-table :data="emps" border stripe size="mini">
				...
				<el-table-column prop="name" label="姓名" fixed width="140" align="left"></el-table-column>
				<el-table-column prop="workID" label="工号" width="140" align="left"></el-table-column>
				<el-table-column prop="email" label="电子邮件" width="200" align="left"></el-table-column>
				<el-table-column prop="phone" label="电话号码" width="160" align="left"></el-table-column>
				<el-table-column prop="department.name" label="所属部门" width="160" align="left"></el-table-column>
